    ...
    <div className="bg-white border-2 border-[#050505] shadow-[4px_4px_0px_0px_#050505] rounded-xl p-4">
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-3 flex-1 min-w-0">
          <div
            className="w-12 h-12 rounded-lg border-2 border-[#050505] flex items-center justify-center flex-shrink-0"
        ...
        <div className="mt-3 pt-3 border-t border-slate-700 flex gap-2">
          {onEdit && (
            <button
              ...
              className="flex-1 px-3 py-2 text-xs font-medium bg-slate-700 hover:bg-slate-600 text-white rounded-lg transition-colors"
            >
              Edit
            </button>
          )}
          {onDelete && (
            <button
              ...
              className="flex-1 px-3 py-2 text-xs font-medium bg-red-900/30 hover:bg-red-900/50 text-red-400 rounded-lg transition-colors"
            >
              Delete
            </button>
          )}
